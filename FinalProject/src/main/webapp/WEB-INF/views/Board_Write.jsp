...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
		...
		<form name="write" onsubmit="return WriteNullCheck()">
			<h1>게시글 작성</h1>
			<br><br>
			<table>
				<tr>
					...
					<td>
					<!-- API되면 고치기 -->
						<select name="write_area">
							<option value="">==지역 선택==</option>
							<option value="dkdkd">dkdk</option>
						</select>
					</td>
					<td>
						<select name="write_exp">
							<option value="">==고속도로 선택==</option>
							<option value="dkdkd">dkdk</option>
						</select>
					</td>
				</tr>
			...
			<textarea class="ckeditor" id="test" name="write_text"></textarea>
			<script type="text/javascript">
