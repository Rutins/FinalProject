...
function ConfirmPw(pw){
	var pwcheck=document.pwcheckform.pwcheck.value;
	if(pwcheck.length<1){
		alert("비밀번호를 입력해주세요.");
		return false;	
	}
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="confirm" id="confirm">
		...
		<section>			
			<table>
				<tr><td>본인 확인을 위해 비밀번호를 입력해주세요.<br>
				<form id="confirm" name="pwcheckform" method="post" onsubmit="return ConfirmPw()" action="Mypage">
				<input type="password" name="pwcheck" id="my_pw"><br><br>
