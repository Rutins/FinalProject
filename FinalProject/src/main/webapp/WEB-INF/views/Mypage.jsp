		...
		<section>			
			<table>
				<tr>
					...
					<td><input type="button" class="btn btn-primary btn-lg main_logon_btn2" value="회원정보수정" onClick="location.href='Change'">&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-primary btn-lg main_logon_btn2" value="회원탈퇴" onClick="location.href='End'"></td>
				</tr>
				<tr>
					<td colspan="2">
					<input type="button" class="btn btn-primary btn-lg main_logon_btn2" value="내가 쓴 글 목록"> &nbsp;&nbsp;&nbsp;&nbsp;사용자가 쓴 글을 확인할 수 있으며 수정, 삭제할 수 있습니다.
					</td>
				</tr>
				<tr>
					<td colspan="2">
					<input type="button" class="btn btn-primary btn-lg main_logon_btn2" value="좋아요한 글 목록"> &nbsp;&nbsp;&nbsp;&nbsp;좋아요한 글을 확인할 수 있으며 좋아요 취소가 가능합니다.
					</td>
				</tr>
			</table>
