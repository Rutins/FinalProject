...
<script>
function toggle(idid){
	var a = document.getElementById(idid);
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="QA">문의 사항
...
<form action="getLogin" name="login" onsubmit="return LoginNullCheck()">
		...
		<div id="QA" class="QA">
		<center><h1>자주 묻는 질문</h1></center><br>
		<section>			
			<table>
				<tr><td class="num">1</td>
					<td class="title">회원가입은 어떻게 하나요?</td>
					<td class="hits" onclick="toggle('hide1');">+</td></tr>
			</table>
			<table>
				<tr><td id="hide1">회원가입 버튼을 눌러주세요</td></tr>
			</table>
			<table>
				<tr><td class="num">2</td>
					<td class="title">게시글을 작성하고 싶어요</td>
					<td class="hits" onclick="toggle('hide2');">+</td></tr>
			</table>
			<table>
				<tr><td id="hide2">글 작성하기 버튼을 눌러주세요</td></tr>			
			</table>
		</section>
		</div>	
	</div>	
